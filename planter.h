...
#define CAL_VAL_LL_ADDR (uint8_t*)0x00
#define CAL_VAL_RL_ADDR (uint8_t*)0x01
#define CAL_VAL_LH_ADDR (uint8_t*)0x02
#define CAL_VAL_RH_ADDR (uint8_t*)0x03

#define WARN_SETTING_ADDR (uint8_t*)0x04
